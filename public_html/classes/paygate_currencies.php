...
class Currencies
{
    ...
    protected static array $dataArray = [
        [
            'Country'      => 'Afghanistan',
            'CountryCode'  => 'AFG',
            'Currency'     => 'Afghani',
        ...
        [
            'Country'      => 'European Monetary Cooperation Fund',
            'CountryCode'  => '--',
        ...
        [
            'Country'      => 'Iran Airlines',
            'countryCode'  => '--',
            'Currency'     => 'Iranian Airline Rate',
            'CurrencyCode' => 'IRA'
        ],
        [
        ...
        [
            'Country'      => 'Russian Ruble (Domestic)',
            'CountryCode'  => 'RUS',
            'Currency'     => 'Russian Ruble (Domestic)',
            'CurrencyCode' => 'RUR'
        ],
        [
            'Country'      => 'Rwanda',
        ...
        [
            'Country'      => 'So. Georgia and So. Sandwich Is.',
            'CountryCode'  => 'SGS',
        ...
        [
            'Country'      => 'Sudan Airlines',
            'CountryCode'  => '--',
            'Currency'     => 'Sudan Airline Rate',
            'CurrencyCode' => 'SDA'
        ],
        [
            'Country'      => 'Suriname',
        ...
        [
            'Country'      => 'Svalbard and Jan Mayen Is.',
            'CountryCode'  => 'SJM',
            'Currency'     => 'Norwegian Krone',
            'CurrencyCode' => 'NOK'
        ],
     ...
     * @return array
     */
    public static function getCurrencies($permitted = null): array
    {
        $dataArray = [];
        $currency  = [];
        if (isset($permitted)) {
        ...
        if ($permitted) {
            foreach (self::$dataArray as $items) {
                $currency['CurrencyCode'] = $items['CurrencyCode'];
                $currency['Currency']     = $items['Currency'];
                if (in_array($items['CurrencyCode'], $allowed)) {
                    $dataArray[] = $currency;
                }
            }
        } else {
        ...
        $dataArray = array_unique(array_values($dataArray), SORT_REGULAR);
        asort($dataArray);
    ...
    public static function getCountries(): array
    {
        ...
        $country   = [];
        foreach (self::$dataArray as $items) {
            $country['CountryCode'] = $items['CountryCode'];
