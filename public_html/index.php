...
<form action="index.php" method="post">
    ...
    <p>Please note that fullstops (.) should not be added to the end of the below fields, as these will be added autoomatically.
  ...
  <div class="form-group">
    ...
    <small id="method_of_confirmationHelp" class="form-text text-muted">Method of Confirmtion e.g. booking number / booking voucher etc. and must mention the use of courier and/or postal services and associated costs, if applicable.</small>
  </div>
  <div class="form-group">
